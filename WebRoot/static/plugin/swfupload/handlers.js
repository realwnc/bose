...
function uploadSuccess(file, serverData) {
	try {
		...
		progress.setStatus("Complete!!![100%]");
		progress.toggleCancel(false);
		updateDisplay.call(this, file);
	} catch (ex) {
		this.debug(ex);
...
function uploadError(file, errorCode, message) {
	try {
		...
		case SWFUpload.UPLOAD_ERROR.UPLOAD_STOPPED:
			...
			break;
		case SWFUpload.UPLOAD_ERROR.MEDIA_SIZE_TOOBIG:/*add by wncheng*/
			progress.setStatus("Media width*height can not bigger than 1920*1080");
			this.debug("Error Code: Media size can not bigger than 1920*1080, File name: " + file.name + ", File size: " + file.size + ", Message: " + message);
			break;
		case SWFUpload.UPLOAD_ERROR.MEDIA_CODEC_INVALID:/*add by wncheng*/
			progress.setStatus("Media codec not support");
			this.debug("Error Code: Media codec not support, File name: " + file.name + ", File size: " + file.size + ", Message: " + message);
			break;
		default:
