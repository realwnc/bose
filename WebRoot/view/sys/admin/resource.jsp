...
<script type="text/javascript">
    ...
    $(function() {
        treeGrid = $('#treeGrid').treegrid({
            url : '${path }/sys/resource/findTreeGrid.do',
            idField : 'id',
            treeField : 'name',
            parentField : 'pid',
            fit : true,
            ...
            columns : [ [ {
                ...
                formatter : function(value, row, index) {
                    var str = '';
                        <shiro:hasPermission name="/resource/edit.do">
                        ...
                        <shiro:hasPermission name="/resource/delete.do">
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
    ...
    function editFun(id) {
        ...
        if (node) {
            parent.$.modalDialog({
                ...
                width : 500,
                height : 350,
                href : '${path }/sys/resource/editPage.do?id=' + node.id,
                buttons : [ {
                    text : '确定',
                    handler : function() {
    ...
    function deleteFun(id) {
        ...
        if (node) {
            parent.$.messager.confirm('询问', '您是否要删除当前资源？删除当前资源会连同子资源一起删除!', function(b) {
                if (b) {
                    progressLoad();
                    $.post('${pageContext.request.contextPath}/sys/resource/delete.do', {
                        id : node.id
                    }, function(result) {
                        if (result.success) {
    ...
    function addFun() {
        parent.$.modalDialog({
            ...
            width : 500,
            height : 350,
            href : '${path }/sys/resource/addPage.do',
            buttons : [ {
                text : '添加',
                handler : function() {
                    parent.$.modalDialog.openner_treeGrid = treeGrid;//因为添加成功之后，需要刷新这个treeGrid，所以先预定义好
...
<body>
    ...
    <div id="toolbar" style="display: none;">
        <shiro:hasPermission name="/resource/add.do">
