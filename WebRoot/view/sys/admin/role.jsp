...
<title>角色管理</title>
    ...
    $(function() {
        dataGrid = $('#dataGrid').datagrid({
            url : '${path }/sys/role/findRolePage.do',
            striped : true,
            rownumbers : true,
            pagination : true,
            singleSelect : true,
            ...
            frozenColumns : [ [ {
                ...
                formatter : function(value, row, index) {
                    var str = '';
                        <shiro:hasPermission name="/role/grant.do">
                        ...
                        <shiro:hasPermission name="/role/edit.do">
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
                        ...
                        <shiro:hasPermission name="/role/delete.do">
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
    ...
    function editFun(id) {
        ...
        parent.$.modalDialog({
            ...
            width : 500,
            height : 300,
            href : '${path }/sys/role/editPage.do?id=' + id,
            buttons : [ {
                text : '确定',
                handler : function() {
    ...
    function grantFun(id) {
        ...
        parent.$.modalDialog({
            ...
            width : 500,
            height : 500,
            href : '${path }/sys/role/grantPage.do?id=' + id,
            buttons : [ {
                text : '确定',
                handler : function() {
                    parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
...
<body class="easyui-layout" data-options="fit:true,border:false">
    ...
    <div id="toolbar" style="display: none;">
        <shiro:hasPermission name="/role/add.do">
