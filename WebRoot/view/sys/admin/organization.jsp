...
<script type="text/javascript">
    ...
    $(function() {
        treeGrid = $('#treeGrid').treegrid({
            url : '${path }/sys/organization/findTreeGrid.do',
            idField : 'id',
            treeField : 'name',
            parentField : 'pid',
            fit : true,
            ...
            columns : [ [ {
                ...
                formatter : function(value, row, index) {
                    var str = '';
                        <shiro:hasPermission name="/organization/edit.do">
                        ...
                        <shiro:hasPermission name="/organization/delete.do">
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
            ...
            onLoadSuccess:function(data){
                ...
                $('#treeGrid').datagrid('fixRowHeight');
            },
            toolbar : '#toolbar'
        });
    });
    ...
    function editFun(id) {
        ...
        if (node) {
            parent.$.modalDialog({
                ...
                width : 500,
                height : 300,
                href : '${path }/sys/organization/editPage.do?id=' + node.id,
                buttons : [ {
                    text : '确定',
                    handler : function() {
    ...
    function deleteFun(id) {
        ...
        if (node) {
            parent.$.messager.confirm('询问', '您是否要删除当前资源？删除当前资源会连同子资源一起删除!', function(b) {
                if (b) {
                    progressLoad();
                    $.post('${path }/sys/organization/delete.do', {
                        id : node.id
                    }, function(result) {
                        if (result.success) {
    ...
    function addFun() {
        parent.$.modalDialog({
            ...
            width : 500,
            height : 300,
            href : '${path }/sys/organization/addPage.do',
            buttons : [ {
                text : '添加',
                handler : function() {
                    parent.$.modalDialog.openner_treeGrid = treeGrid;//因为添加成功之后，需要刷新这个treeGrid，所以先预定义好
...
<body>
    <div class="easyui-layout" data-options="fit:true,border:false">
        ...
        <div id="toolbar" style="display: none;">
            <shiro:hasPermission name="/organization/add.do">
